                            ...
                            <Border Background="#F8FAFC" BorderBrush="#CBD5E1" BorderThickness="1" CornerRadius="12" Padding="10" Margin="0,0,0,10">
                                <StackPanel>
                                    <DockPanel LastChildFill="False" Margin="0,0,0,8">
                                        <TextBlock Text="Presets" FontWeight="Bold" FontSize="14" Foreground="#0F172A" VerticalAlignment="Center" Margin="0,0,10,0"/>
                                        ...
                                        <Button Name="ClearAllBtn" Content="Clear" Background="#475569" Foreground="White" Padding="10,5"/>
                                    ...
                                    <DockPanel LastChildFill="False">
                                        <Button Name="StandardPresetBtn" Content="Standard" Background="#334155" Foreground="White" Padding="10,5"/>
                                        <Button Name="MinimalPresetBtn" Content="Minimal" Background="#0F766E" Foreground="White" Padding="10,5"/>
                                        <CheckBox Name="EnterpriseModeCB" Content="Enterprise Mode (Recommended)" IsChecked="True" Margin="8,2,0,0" VerticalAlignment="Center"/>
                                    </DockPanel>
                                </StackPanel>
                            </Border>
